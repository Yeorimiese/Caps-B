<?php
	...
	switch ($_POST['form']) {
				...
				while($row = mysqli_fetch_array($res)){
					...
					echo "<tr style='cursor:pointer;'>
	                        ...
	                        <td style='white-space: nowrap; text-align: center;'>
	                        	<i class=' fas fa-file-medical text-info' style='font-size:1.4rem;' onclick='modaleditprod(\"". $row[0] ."\");'></i>
							</td>
	                    </tr>";
				}
			} else {
        ...
        case 'addprescription':
        	$genID = generateID($connection, 'prescriptionID', 'prescriptions', 'PR');

			$addprescription = mysqli_query($connection, "INSERT INTO prescriptions SET prescriptionID = '" . $genID . "', appointmentID = '" . $_POST['textappointmentID'] . "', vetID = '" . $_SESSION['vetuserID'] . "', medication = '" . $_POST['textprescriptmedication'] . "', dosage = '" . $_POST['textprescriptdosage'] . "', quantity = '" . $_POST['textprescriptquantity'] . "', directions = '" . $_POST['textprescriptdirections'] . "', date_added = '" . date("Y-m-d") . "';");
