<?php
	...
	switch ($_POST['form']) {
		...
		case "loadproductlistPagination":
			...
			$page = $_POST["page"];
			$rowCount = mysqli_fetch_row(mysqli_query($connection, "SELECT COUNT(a.id) FROM appointments AS a LEFT JOIN tbl_user AS b ON a.userID = b.userID LEFT JOIN pets AS c ON a.petID = c.petID LEFT JOIN services AS d ON a.serviceID = d.serviceID WHERE a.appstatus = 'COMPLETED' " . $searchuseracc . ";"));
			$rowsperpage = 10;
			$range = 1;
