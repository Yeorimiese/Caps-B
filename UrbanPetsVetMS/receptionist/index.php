<?php
    include("connect.php");
    session_start();
    if(empty($_SESSION['receptuserID']))
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid containerfluidneed" style="padding: 20px 20px;">
                <?php
                  if(!isset($_GET['url'])){
                        echo "<script>window.location='index.php?url=pendingappointment';</script>";
                  }
                  else{
                    ...
                    if($_GET['url'] == "patientbillings"){
                      include "salesreport/index.php";
                    }

                    if($_GET['url'] == "customers"){
                      include "customer/index.php";
                    }

                    if($_GET['url'] == "pets"){
                      include "pets/index.php";
                    }
                  }
                ?>
            </div>
