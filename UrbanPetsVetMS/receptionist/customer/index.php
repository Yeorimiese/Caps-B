...
<div class="container-fluid" style="padding: 15px 15px; background-color: white; min-height: 540px; margin-top: 15px;">
            ...
            <div class="form-horizontal form-material">
                <div class="row">
                    <div class="col-md-11" style="padding-right: 0px; flex: 0 0 95%; max-width: 95%;">
                        <input type="text" class="form-control underlined" id="txtsearchuser" placeholder="Search Customer . . ." style="height: 40px;font-size: .9rem;padding-left: 5px;">
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                <table data-height="350" class="table table-bordered fixTable table-hover table-striped" style="margin-bottom: 0px;">
                    <thead class="bg-success text-white">
                        <tr>
                            <th style="width: 2%;white-space: nowrap;"> User ID </th>
                            <th style="width: 15%;white-space: nowrap;"> Fullname </th>
                            <th style="width: 2%;white-space: nowrap;"> Contact No. </th>
                            <th style="width: 2%;white-space: nowrap;"> Email </th>
            ...
            <input id="txtuserlistPageCount" type="hidden">
