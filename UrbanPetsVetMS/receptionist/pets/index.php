            ...
            <div class="card-body" style="padding-top: .5rem; padding-bottom: .5rem;">
                <div class="row page-titles rowpageheaderpadd" style="padding-bottom: 0px;">
                    <div class="col-md-6 col-6 align-self-center" style="padding-left:10px;">
                        <h3 class="mb-0 mt-0 headerfontfont text-themecolor" style="font-weight: 600;">PETS</h3>
                    </div>
...
<div class="container-fluid" style="padding: 15px 15px; background-color: white; min-height: 540px; margin-top: 15px;">
    <div class="row" style="margin-bottom: .5rem;">
            ...
            <div class="form-horizontal form-material">
                <div class="row">
                    <div class="col-md-11" style="padding-right: 0px; flex: 0 0 95%; max-width: 95%;">
                        <input type="text" class="form-control underlined" id="txtsearchpet" placeholder="Search Pet . . ." style="height: 40px;font-size: .9rem;padding-left: 5px;">
                    </div>
        ...
        <div class="col-md-8 coldashboardbox4" style="margin-bottom:15px;">
            <button type="button" class="btn waves-effect waves-light btn-secondary float-right buttonproduct loginbutton" onclick="modaladdproduct();" style="background: linear-gradient(to right, #599dea 0%, #599dea 100%) !important; border: 1px solid #599dea !important;font-weight: 500;"><i class="fas fa-plus"></i> Add</button>
        </div>
    </div>
            ...
            <div class="mb-3">
                <table data-height="350" class="table table-bordered fixTable table-hover table-striped" style="margin-bottom: 0px;">
                    <thead class="bg-success text-white">
                        <tr>
                            <th style="width: 2%;white-space: nowrap;"> Pet ID </th>
                            <th style="width: 15%;white-space: nowrap;"> Name </th>
                            <th style="width: 5%;white-space: nowrap;"> Type </th>
                            <th style="width: 5%;white-space: nowrap;"> Breed </th>
                            <th style="width: 5%;white-space: nowrap;"> Sex </th>
                            <th style="width: 5%;white-space: nowrap;"> Weight </th>
                            <th style="width: 5%;white-space: nowrap;"> Owner </th>
                            <th style="width: 5%;white-space: nowrap; text-align: center;"> Option </th>
                        </tr>
                    </thead>
                    <tbody id="tblpetlist"></tbody>
                </table>
            </div>

            <input id="txtpetlistPageCount" type="hidden">
...
<?php 
    include("pets/modal.php"); 
    include("pets/script.php"); 
?>
