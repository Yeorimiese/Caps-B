            ...
            <div class="card-body" style="padding-top: .5rem; padding-bottom: .5rem;">
                <div class="row page-titles rowpageheaderpadd" style="padding-bottom: 0px;">
                    <div class="col-md-6 col-6 align-self-center" style="padding-left:10px;">
                        <h3 class="mb-0 mt-0 headerfontfont text-themecolor" style="font-weight: 600;">PATIENT BILLINGS</h3>
                    </div>
                    <div class="col-md-6 col-6 align-self-center" style="padding-right:10px;">
                        <ol class="breadcrumb float-right headerfontfont">
                            ...
                            <li class="breadcrumb-item active">Patient Billings</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                <table data-height="350" class="table table-bordered fixTable table-hover table-striped" style="margin-bottom: 0px;">
                    <thead class="bg-success text-white">
                        <tr>
                            <th style="width: 2%;white-space: nowrap;"> Transaction ID </th>
                            <th style="width: 2%;white-space: nowrap;"> Appointment ID </th>
                            <th style="width: 20%;white-space: nowrap;"> Customer </th>
                            <th style="width: 10%;white-space: nowrap;"> Service </th>
                            <th style="width: 5%;white-space: nowrap;"> Payment Date </th>
                            <th style="width: 5%;white-space: nowrap;"> Amount Paid </th>
                        </tr>
                    </thead>
...
<?php 
    include("salesreport/modal.php"); 
    include("salesreport/script.php"); 
?>
